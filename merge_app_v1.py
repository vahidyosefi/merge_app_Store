...
adgham_app.to_excel(r'D:\python\PowerBI_App_store\progress\test\adgham_app1.xlsx', index=False)
...
learn.to_excel(r'D:\python\PowerBI_App_store\progress\test\learn.xlsx', index=False)
